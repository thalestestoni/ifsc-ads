<?php
    ...
    session_start();
    $_SESSION['estanteLivros'] = $estante;
    
    $listaLivros = $estante->obterListaLivros();
?>
...
<body>
    <div class="vh-100 vw-100 p-5">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                <?php foreach ($listaLivros as $posicao=>$livro): ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo "VisualizacaoDadosLivro.php?posicaoLivro=" .$posicao ?>">
